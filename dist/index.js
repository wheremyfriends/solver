...
var Solver = class _Solver {
  ...
  solve(input, index) {
    ...
    (0, import_roarr.Roarr)(Object(daysRank), "daysRank");
    ...
    (0, import_roarr.Roarr)(Object(this.result.map((classes) => prettify(classes))), "this.result");
  ...
  _solve(counter, numlessons) {
    ...
    if (numlessons <= 0) {
      this.numsols++;
      (0, import_roarr.Roarr)(prettify(this.curClasses), "Solution");
